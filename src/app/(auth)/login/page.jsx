                ...
                <div className='w-full max-w-7xl bg-[#DDE5FA] h-screen flex justify-center rounded-2xl'>
                    <div className='w-3/4 flex justify-center items-center space-x-3 space-x-reverse'>
                        ...
                        <div className='w-1/5 flex flex-col justify-center items-center space-y-5'>
                            <Link href='/login' className="text-indigo-950 bg-slate-100 font-extrabold rounded-2xl w-[154px] h-[94px] shadow-gray-400 shadow-md flex ">ورود</Link>
                            <Link href='/signup' className="text-slate-100 bg-blue-700 font-extrabold rounded-2xl w-[154px] h-[94px] shadow-gray-400 shadow-md flex ">ثبت نام</Link>
                        </div>
