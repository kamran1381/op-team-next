        ...
        <>
            <div className='xl:w-1/2 w-full h-fit max-w-7xl flex lg:flex-row flex-col-reverse xl:justify-center justify-around items-center lg:p-2 lg:pb-0 mt-32  relative'>
                ...
                <div className='lg:w-[400px] lg:h-[600px] w-[300px] h-[500px] flex justify-center items-center relative z-20 '>
                    <div className='w-72 h-72 lg:w-96 lg:h-96 rounded-full bg-gradient-to-b from-[#18DBE7] to-[#185CE7] flex justify-center items-center lg:bottom-1 bottom-1 lg:-left-12 relative'>
