        ...
        <>
            <div className='w-full h-fit max-w-7xl flex lg:flex-row flex-col-reverse xl:justify-center justify-around items-center lg:p-2 lg:pb-0 mt-32 relative'>
                <div className='flex flex-col lg:w-1/3 lg:items-start w-full items-center space-y-3 p-5 z-20'>
                    ...
                    <span className='w-fit bg-indigo-100 px-5 py-1 rounded-full text-xs font-extrabold text-[#00004E]'>به ما اعتماد کنید</span>
                    <p className='text-[#00004E] lg:text-[27px] text-xl font-extrabold leading-10 lg:text-right text-center'>ساخت انواع سایت های فروشگاهی،شرکتی،خبری و مقاله ایی،گیمینگ،شخصی و ....</p>
                    <span className='text-xs font-extrabold text-[#00164E]'>تیم خوش ذوق در حوزه برنامه نویسی و طراحی سایت</span>
