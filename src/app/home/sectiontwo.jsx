    ...
    return (
        <div id='aboutUs' className='bg-slate-100 w-full flex justify-center relative'>
            <div className='w-full max-w-7xl flex flex-col lg:flex-row items-start lg:space-x-20 lg:space-x-reverse py-10 lg:space-y-0 space-y-5 xl:px-0 px-2 z-10'>
                <div className='w-full lg:w-1/3 lg:h-[800px] flex justify-center items-center relative '>
                    ...
                    <div className=' z-10 '>
                        <Image src='/assets/images/sectionTwoImg.png' className='object-contain rounded-md' loading='lazy' width={400} height={400} alt='لوگوی او پی تیم' />
                    </div>
                </div>
