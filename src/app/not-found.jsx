            ...
            <div className='w-full max-w-7xl bg-[#DDE5FA] h-screen flex justify-center rounded-2xl'>
                <main class='flex items-center justify-center w-full min-h-screen py-8 text-gray-900 page md:py-16 '>
                    <div class='relative flex flex-col items-center w-full gap-8 px-8 '>
                        ...
                        <p class='text-3xl font-bold capitalize'>شما به یکجای مخفی امده اید </p>
                        <p class='text-2xl font-medium break-words text-dull'>متاسفانه این یک صفحه 404 هست شما شاید مبجور باشید که به یک صفحه  دیگر بروید </p>
                        <div class='flex flex-col justify-between w-full gap-8 md:flex-row md:gap-32 xl:px-16'>
                            <a to="/" class='flex items-center justify-center w-full gap-4 p-3 font-semibold capitalize border-2 border-blue-500 rounded shadow-lg md:w-fit hover:bg-blue-500 md:p-6 focus:outline-none hover:scale-105 active:scale-90 hover:shadow-xl '>
