  ...
  return (
    <form className='sm:w-2/3 w-full p-5 pb-0 flex flex-col items-center space-y-5' onSubmit={handleEmailSubmit}>
      <div className='w-full flex items-center space-x-reverse space-x-5'>
        <input onChange={(e) => setEmail(e.target.value)} name="email" type="text" className='w-full border shadow p-3 rounded-2xl text-sm outline-none hover:bg-slate-200 transition-colors' placeholder='لطفا ادرس ایمیل خود را وارد کنید' />
      </div>
