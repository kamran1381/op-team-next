    ...
    >
      ...
      <div className="absolute  bottom-0 right-0 flex flex-col items-start space-x-4">
        <div className="pr-3">
          <button
            type="button"
            className="text-white bg-[#0045CE] focus:outline-none focus:ring-4  font-medium rounded-xl text-sm px-5 py-2.5 text-center me-2 mb-2"
          >
            بک اند
          </button>
          <button
            type="button"
            className="text-white bg-[#0045CE] focus:outline-none focus:ring-4  font-medium rounded-xl text-sm px-4 py-2.5 text-center me-2 mb-2"
          >
            فرانت اند
          </button>
        </div>
